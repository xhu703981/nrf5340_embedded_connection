...
struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x16b9d, (ISR)0x2748f}, /* 42 */
	{(const void *)0x1755d, (ISR)0x2748f}, /* 43 */
